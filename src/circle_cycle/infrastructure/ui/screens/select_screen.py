"""Character selection screen for team building."""
...
class SelectScreen(tk.Frame):
    ...
    def _make_toggle_command(self, character_id: str) -> Callable[[], None]:
        """Create a callback for toggling selection of a specific character."""

        def _command() -> None:
            self.toggle_selection(character_id)
